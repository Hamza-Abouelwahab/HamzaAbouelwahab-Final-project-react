...
function Carousel2() {
  const products = [
    { img: images.shopi2, title: "Boxy3 T-Shirt with Roll sleeve", price: "$20,00" },
    { img: images.shopy3, title: "Boxy2 T-Shirt with Roll sleeve", price: "$20,00" },
    { img: images.shopy4, title: "Boxy1 T-Shirt with Roll sleeve", price: "$20,00" },
    { img: images.shopy5 , title: "Boxy T-Shirt with Roll sleeve Details", price: "$20,00" },
    { img: images.shopy7, title: "Boxy7 T-Shirt with Roll sleeve", price: "$20,00" },
    { img: images.shopy8, title: "Boxy6 T-Shirt with Roll sleeve", price: "$20,00" },
    { img: images.item03, title: "Boxy5 T-Shirt with Roll sleeve", price: "$20,00" },
    { img: images.shopy4, title: "Boxy4 T-Shirt with Roll sleeve", price: "$20,00" },
  ];
